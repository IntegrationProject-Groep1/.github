...
# 🎉 ShiftFestival Integration Platform

### Desideriushogeschool — Integratieproject Groep 1
...
[![License](https://img.shields.io/badge/Academiejaar-2025--2026-6B46C1)](#)

<br/>

![ShiftFestival](https://raw.githubusercontent.com/IntegrationProject-Groep1/.github/main/profile/badges/project.svg)
![Messaging](https://raw.githubusercontent.com/IntegrationProject-Groep1/.github/main/profile/badges/rabbitmq.svg)
...
De publieke **voordeur** van het platform. Drupal 10 verzorgt de bezoekers­website waar deelnemers zich kunnen inschrijven voor sessies. De container fungeert tevens als **SSL-terminatie** en **reverse proxy**: alle HTTPS-verkeer op poort 443 wordt doorgestuurd naar de juiste interne dienst.
...
- `frontend.user.registered` → CRM (nieuwe inschrijving)
- `frontend.user.checkin` → Kassa / CRM (check-in aan de kassa)
...
**Berichtenstromen (RabbitMQ):**
- → CRM: consumptie gekoppeld aan klant
- → Facturatie: betaling verwerkt (trigger factuurstatus)
...
**Berichtenstromen (RabbitMQ):**
- ← CRM: inschrijving / consumptie / betaling / annulering
- → Mailing: factuur klaar voor verzending
- → DLQ: foutieve berichten (Dead Letter Queue)
...
**Berichtenstromen (RabbitMQ):**
- ← Frontend: nieuwe inschrijving
- ← Kassa: betaling / consumptie
- → Facturatie: klantgegevens doorgeven
- → Mailing: contactlijsten aanleveren
...
**Berichtenstromen (RabbitMQ):**
- ← `calendar.invite` (inkomend van Frontend)
- → `planning.session.created` (uitkomend naar alle teams)
